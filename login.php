      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
              ...
              <h2 class="card-title text-center">SISTEM PENDUKUNG KEPUTUSAN (STUDI KASUS PENENTUAN KOS TERBAIK DI SEKITAR KAMPUS)</h2>
                        
                <p class="card-title text-center"><img src="images/muris-studio.jpg" width="100"></p>
