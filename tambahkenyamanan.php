...
<div class="content-wrapper">
        <div class="container">
              <div class="row">
                    ...
                    <h1 class="mt-5">Tambah Kriteria Kenyamanan</h1>
                        ...
                        <div class="panel-body">
                             ...
                             <form action="" method="post" enctype="multipart/form-data" id="frm-mhs">
                                          ...
                                          <div class="form-group">
                                            ...
                                            while($r=mysql_fetch_array($tampil)){
                                            echo "<option value=$r[id_kenyamanan]>$r[kenyamanannya]-$r[id_kenyamanan]</option>";
                                            }
                                            echo "</select>";
                                            ?>
                                          </div>
                              ...
                              <?php
                                      ...
                                      if(isset($pemilik,$kenyamanan)){
                                        if((!$pemilik)||(!$kenyamanan)){
                                      ...
                                      $add_kelas="INSERT INTO kenyamanankos (id_kenyamanan,id_kamar) VALUES 
                                      ('$kenyamanan','$pemilik')";
