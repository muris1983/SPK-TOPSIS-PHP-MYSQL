...
?>
	...
	$sqla = mysql_query("SELECT * FROM pemilik,kamar WHERE pemilik.id_pemilik = kamar.id_pemilik AND pemilik.nama_kos LIKE '$id'");
	$dataa = mysql_fetch_array($sqla);

  $idnya = $dataa['id_kamar'];

  $sql = mysql_query("SELECT * FROM pemilik,kamar WHERE pemilik.id_pemilik = kamar.id_pemilik AND kamar.id_kamar='$idnya'");
...
<div class="img-big-wrap">
  ...
  <dd>
    <?php
                        $fasilitas = mysql_query("SELECT * FROM fasilitas,fasilitaskos WHERE fasilitas.id_fasilitas = fasilitaskos.id_fasilitas AND fasilitaskos.id_kamar='$idnya'");
